...
class MockEmbeddingProvider(EmbeddingProvider):
    ...
    def pricing_info(self) -> Dict[str, float]:
        ...
        return {"per_token": 0.0001, "per_request": 0.001}
...
def create_mock_rag_search_result(
    ...
    return RAGSearchResult(text=text, metadata=metadata, score=score, chunk_id=chunk_id)
...
def create_mock_document(
    ...
    return Document(content=content, metadata=metadata, document_id=document_id)
