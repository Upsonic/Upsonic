...
class TestCSVLoaderSimple(unittest.TestCase):
    ...
    def test_include_columns_selection(self):
        ...
        config = CSVLoaderConfig(include_columns=["name", "city"])
        loader = CSVLoader(config)
    ...
    def test_metadata_inclusion(self):
        ...
        config = CSVLoaderConfig(include_metadata=True)
        loader = CSVLoader(config)
    ...
    def test_split_mode_per_row(self):
        ...
        config = CSVLoaderConfig(split_mode="per_row", include_metadata=True)
        loader = CSVLoader(config)
    ...
    def test_split_mode_per_chunk(self):
        ...
        config = CSVLoaderConfig(
            split_mode="per_chunk", rows_per_chunk=2, include_metadata=True
        )
        loader = CSVLoader(config)
    ...
    def test_split_mode_single_document(self):
        ...
        config = CSVLoaderConfig(split_mode="single_document", include_metadata=True)
        loader = CSVLoader(config)
