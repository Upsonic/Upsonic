...
def basic_config():
    ...
    return DoclingLoaderConfig(extraction_mode="chunks", chunker_type="hybrid")


@pytest.fixture
def markdown_config():
    """Configuration for markdown extraction."""
    return DoclingLoaderConfig(extraction_mode="markdown")
...
class TestDoclingLoaderConfig:
    ...
    def test_markdown_export_options(self):
        ...
        config = DoclingLoaderConfig(
            extraction_mode="markdown", markdown_image_placeholder="[IMAGE]"
        )
    ...
    def test_advanced_processing_options(self):
        ...
        config = DoclingLoaderConfig(
            parallel_processing=False, batch_size=20, confidence_threshold=0.8
        )
    ...
    def test_table_structure_configuration(self):
        ...
        config = DoclingLoaderConfig(
            enable_table_structure=True, table_structure_cell_matching=False
        )
    ...
    def test_page_range_configuration(self):
        ...
        config = DoclingLoaderConfig(page_range=(1, 10), max_pages=10)
    ...
    def test_performance_configuration(self):
        ...
        config = DoclingLoaderConfig(
            parallel_processing=False, batch_size=5, confidence_threshold=0.8
        )
...
class TestDoclingLoaderWithMocks:
    ...
    def test_load_single_document_chunks(
        self, mock_converter_class, basic_config, sample_pdf_path
    ):
    ...
    @patch("upsonic.loaders.docling.DocumentConverter")
    def test_load_single_document_markdown(
        self, mock_converter_class, markdown_config, sample_pdf_path
    ):
    ...
    def test_load_multiple_documents(
        self, mock_converter_class, basic_config, tmp_path
    ):
...
class TestDoclingLoaderErrorHandling:
    ...
    def test_missing_file_error_raise(self, basic_config):
        ...
        config = DoclingLoaderConfig(extraction_mode="chunks", error_handling="raise")
    ...
    def test_missing_file_error_warn(self, basic_config, caplog):
        ...
        config = DoclingLoaderConfig(extraction_mode="chunks", error_handling="warn")
        loader = DoclingLoader(config)
    ...
    def test_missing_file_error_ignore(self, basic_config):
        ...
        config = DoclingLoaderConfig(extraction_mode="chunks", error_handling="ignore")
        loader = DoclingLoader(config)
    ...
    def test_url_disabled_error(self, basic_config):
        ...
        config = DoclingLoaderConfig(
            extraction_mode="chunks", support_urls=False, error_handling="raise"
        )
        loader = DoclingLoader(config)
    ...
    def test_empty_content_skip(self, basic_config):
        ...
        DoclingLoaderConfig(extraction_mode="chunks", skip_empty_content=True)
...
class TestDoclingLoaderFormats:
    ...
    def test_format_restrictions(self):
        ...
        config = DoclingLoaderConfig(
            extraction_mode="chunks", allowed_formats=["pdf", "docx"]
        )
        loader = DoclingLoader(config)
...
class TestDoclingLoaderIntegration:
    ...
    def test_real_document_loading(self, sample_md_path):
        ...
        try:
            config = DoclingLoaderConfig(
                extraction_mode="markdown", error_handling="raise"
            )
            loader = DoclingLoader(config)
