...
class TestPdfPlumberLoaderSafe(unittest.TestCase):
    ...
    def test_table_extraction_markdown(self):
        ...
        config = PdfPlumberLoaderConfig(
            extract_tables=True, table_format="markdown", extraction_mode="text_only"
        )
        loader = PdfPlumberLoader(config)
    ...
    def test_table_extraction_csv(self):
        ...
        pdf_path = self.test_pdfs["table_heavy"]
        config = PdfPlumberLoaderConfig(
            extract_tables=True, table_format="csv", extraction_mode="text_only"
        )
        loader = PdfPlumberLoader(config)
    ...
    def test_table_extraction_grid(self):
        ...
        pdf_path = self.test_pdfs["table_heavy"]
        config = PdfPlumberLoaderConfig(
            extract_tables=True, table_format="grid", extraction_mode="text_only"
        )
        loader = PdfPlumberLoader(config)
    ...
    def test_page_range_extraction(self):
        ...
        pdf_path = self.test_pdfs["multi_page"]
        config = PdfPlumberLoaderConfig(
            start_page=2, end_page=3, extraction_mode="text_only"
        )
        loader = PdfPlumberLoader(config)
    ...
    def test_corrupted_pdf_handling(self):
        ...
        config = PdfPlumberLoaderConfig(
            error_handling="warn", extraction_mode="text_only"
        )
        loader = PdfPlumberLoader(config)
    ...
    def test_metadata_extraction(self):
        ...
        pdf_path = self.test_pdfs["simple_text"]
        config = PdfPlumberLoaderConfig(
            include_metadata=True, extraction_mode="text_only"
        )
        loader = PdfPlumberLoader(config)
    ...
    def test_async_batch_loading(self):
        ...
        pdf_paths = [self.test_pdfs["simple_text"], self.test_pdfs["table_heavy"]]
    ...
    def test_whitespace_removal(self):
        ...
        pdf_path = self.test_pdfs["multi_page"]
        config = PdfPlumberLoaderConfig(
            extra_whitespace_removal=True, extraction_mode="text_only"
        )
        loader = PdfPlumberLoader(config)
    ...
    def test_layout_mode_extraction(self):
        ...
        config_layout = PdfPlumberLoaderConfig(
            layout_mode="layout", extraction_mode="text_only"
        )
        ...
        config_simple = PdfPlumberLoaderConfig(
            layout_mode="simple", extraction_mode="text_only"
        )
    ...
    def test_character_margin_settings(self):
        ...
        pdf_path = self.test_pdfs["table_heavy"]
        config = PdfPlumberLoaderConfig(
            char_margin=5.0, line_margin=1.0, extraction_mode="text_only"
        )
        loader = PdfPlumberLoader(config)
    ...
    def test_table_settings_customization(self):
        ...
        config = PdfPlumberLoaderConfig(
            table_settings=custom_table_settings, extraction_mode="text_only"
        )
        loader = PdfPlumberLoader(config)
    ...
    def test_error_handling_modes(self):
        ...
        # Test ignore mode
        config_ignore = PdfPlumberLoaderConfig(
            error_handling="ignore", extraction_mode="text_only"
        )
        ...
        # Test warn mode
        config_warn = PdfPlumberLoaderConfig(
            error_handling="warn", extraction_mode="text_only"
        )
        ...
        # Test raise mode
        config_raise = PdfPlumberLoaderConfig(
            error_handling="raise", extraction_mode="text_only"
        )
    ...
    def test_file_size_limits(self):
        ...
        pdf_path = self.test_pdfs["simple_text"]
        config = PdfPlumberLoaderConfig(
            max_file_size=1000, extraction_mode="text_only"
        )  # Very small limit
        loader = PdfPlumberLoader(config)
    ...
    def test_skip_empty_content(self):
        ...
        config_skip = PdfPlumberLoaderConfig(
            skip_empty_content=True, extraction_mode="text_only"
        )
        ...
        config_keep = PdfPlumberLoaderConfig(
            skip_empty_content=False, extraction_mode="text_only"
        )
    ...
    def test_keep_blank_chars(self):
        ...
        pdf_path = self.test_pdfs["simple_text"]
        config = PdfPlumberLoaderConfig(
            keep_blank_chars=True, extraction_mode="text_only"
        )
        loader = PdfPlumberLoader(config)
