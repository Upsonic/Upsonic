...
class TestJSONChunkingSimple(unittest.TestCase):
    ...
    def setUp(self):
        ...
        array_json = {
            ...
            "metadata": {"total_users": 3, "created_at": "2024-01-01T00:00:00Z"},
        }
    ...
    def test_array_handling_modes(self):
        ...
        config_convert = JSONChunkingConfig(
            convert_lists_to_dicts=True, chunk_size=100, chunk_overlap=20
        )
        ...
        config_no_convert = JSONChunkingConfig(
            convert_lists_to_dicts=False, chunk_size=100, chunk_overlap=20
        )
    ...
    def test_batch_processing(self):
        ...
        documents = [self.simple_doc, self.nested_doc, self.array_doc]
