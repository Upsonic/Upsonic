...
def create_mock_policy(
    ...
    return Policy(
        name=name, description=f"Mock policy: {name}", rule=rule, action=action
    )
...
class TestPolicyManagerInitialization:
    ...
    def test_policy_manager_initialization_no_policies(self):
        """Test PolicyManager initialization with no policies."""
...
class TestPolicyManagerUserPolicy:
    ...
    @pytest.mark.asyncio
    async def test_policy_manager_user_policy_allow(self):
        """Test user policy that allows content."""
    ...
    @pytest.mark.asyncio
    async def test_policy_manager_user_policy_block(self):
        """Test user policy that blocks content."""
...
class TestPolicyManagerAgentPolicy:
    ...
    @pytest.mark.asyncio
    async def test_policy_manager_agent_policy_allow(self):
        """Test agent policy that allows content."""
        policy = create_mock_policy(
    ...
    @pytest.mark.asyncio
    async def test_policy_manager_agent_policy_block(self):
        """Test agent policy that blocks content."""
        policy = create_mock_policy(
...
class TestPolicyManagerMultiplePolicies:
    ...
    @pytest.mark.asyncio
    async def test_policy_manager_multiple_policies_all_allow(self):
        """Test multiple policies that all allow content."""
    ...
    @pytest.mark.asyncio
    async def test_policy_manager_multiple_policies_first_blocks(self):
        """Test multiple policies where the first one blocks."""
    ...
    @pytest.mark.asyncio
    async def test_policy_manager_multiple_policies_sequential_replace(self):
        """Test multiple policies that sequentially replace content."""
    ...
    @pytest.mark.asyncio
    async def test_policy_manager_multiple_policies_mixed_actions(self):
        """Test multiple policies with mixed actions (replace then block)."""
        policy1 = create_mock_policy("Policy 1", confidence=1.0, action_taken="REPLACE")
