...
class TestRuleBasedSelector:
    ...
    def test_cost_priority(self):
        ...
        selector = RuleBasedSelector()
        criteria = SelectionCriteria(prioritize_cost=True, max_cost_tier=3)
    ...
    def test_provider_preference(self):
        ...
        assert (
            "anthropic" in recommendation.model_name.lower()
            or "claude" in recommendation.model_name.lower()
        )
