...
class MCPTool(ToolBase):
    ...
    def __init__(self, handler: "MCPHandler", tool_info: mcp_types.Tool):
...
class MCPHandler:
    ...
    async def _initialize_session(self) -> None:
        ...
        console.print(
            f"[green]Found {len(tools_response.tools)} tools from {self.server_name}[/green]"
        )
    ...
    def get_tools(self) -> List[MCPTool]:
        ...
        try:
            ...
            console.print(
                "[yellow]⚠️  MCP async limitation detected. Attempting threaded connection...[/yellow]"
            )
    ...
    async def disconnect(self) -> None:
        ...
        console.print(
            f"[cyan]MCP handler for {self.server_name} uses on-demand connections[/cyan]"
        )
