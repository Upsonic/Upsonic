...
class DeferredToolResults:
    ...
    def add_approval(
        ...
        self.approvals[tool_call_id] = ToolApproval(
            approved=approved, override_args=override_args, message=message
        )
...
class DeferredExecutionManager:
    ...
    def create_external_call(
        ...
        call = ToolCall(tool_name=tool_name, args=args, tool_call_id=tool_call_id)
        ...
        external_call = ExternalToolCall(
            tool_name=tool_name, tool_args=args, tool_call_id=tool_call_id
        )

        self.execution_history.append(external_call)
        return external_call

    def process_results(self, results: DeferredToolResults) -> List[ToolResult]:
        """
    ...
    def _update_execution_history(self, tool_call_id: str, result: Any) -> None:
