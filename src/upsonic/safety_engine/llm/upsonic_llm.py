...
class UpsonicLLMProvider:
    ...
    def __init__(
        self, agent_name: str = "AI Safety Agent", model: Union[Model, str] = None
    ):
    ...
    def find_keywords(
        self, content_type: str, text: str, language: str = "en"
    ) -> List[str]:
    ...
    async def generate_block_message_async(
    ...
    def anonymize_content(
        ...
        if language == "tr":
            ...
            language_instruction = (
                f" Maintain {language} language structure and context."
            )
    ...
    async def anonymize_content_async(
        self, text: str, keywords: List[str], language: str = "en"
    ) -> str:
    ...
    def translate_text(self, text: str, target_language: str) -> str:
        ...
        try:
            ...
            if not translated or translated == text.strip():
                task.description += (
                    "\n\nWARNING: Previous attempt returned original text. Please ensure to translate to "
                    + target_lang_name
                )
                result = self.agent.do(task)
                translated = result.translated_text.strip()
