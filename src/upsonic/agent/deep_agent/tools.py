...
@tool(sequential=False, show_result=False, docstring_format="google", timeout=60.0)
...
def edit_file(
    ...
    if replace_all:
        ...
        result_msg = (
            f"Successfully replaced {replacement_count} instance(s) in '{file_path}'"
        )
    else:
...
def create_task_tool(deep_agent_instance: Any, subagent_descriptions: List[str]) -> Any:
    """
