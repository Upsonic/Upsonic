...
class TesseractOCR(OCRProvider):
    ...
    def _validate_dependencies(self) -> None:
        ...
        try:
            ...
            unsupported_langs = [
                lang for lang in self.config.languages if lang not in available_langs
            ]
        ...
        try:
            ...
            if self.config.preserve_formatting:
                full_text = pytesseract.image_to_string(
                    image, lang=lang_string, config=tesseract_config
                ).strip()
            else:
    ...
    def get_available_languages(self) -> List[str]:
        ...
        try:
            ...
            return [
                lang for lang in langs if lang != "osd"
            ]  # Exclude orientation/script detection
        except Exception:
