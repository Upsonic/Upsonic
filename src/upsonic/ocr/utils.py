...
def check_poppler_installed():
    ...
    error_message(error_type="Poppler Not Installed", detail=detail)
...
def pdf_to_images(file_path: Union[str, Path], dpi: int = 300) -> List[Image.Image]:
    ...
    try:
        ...
        if (
            "poppler" in error_str
            or "pdftoppm" in error_str
            or "pdfinfo" in error_str
            or "unable to get page count" in error_str
            or type(e).__name__ == "PDFInfoNotInstalledError"
        ):
