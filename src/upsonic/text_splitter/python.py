...
class PythonChunker(BaseChunker[PythonChunkingConfig]):
    ...
    def _chunk_document(self, document: Document) -> List[Chunk]:
        ...
        try:
            ...
            logger.error(
                f"Invalid Python syntax in document {document.document_id}: {e}"
            )
            return []
        ...
        if (
            ...
            merged_text = document.content[
                previous_chunk.start_index : last_chunk.end_index
            ]
