...
class CostTracker:
    ...
    def add_run_result(
        self, run_result: "RunResult", model: Optional["Model"] = None
    ) -> None:
    ...
    def add_stream_result(
        self, stream_result: "StreamRunResult", model: Optional["Model"] = None
    ) -> None:
    ...
    def calculate_cost_from_usage(
        usage: "RequestUsage", model: Union["Model", str]
    ) -> str:
        """
    ...
    @staticmethod
    def calculate_cost_from_run_result(
        run_result: "RunResult", model: Union["Model", str]
    ) -> str:
        """
    ...
    @staticmethod
    def calculate_cost_from_stream_result(
        stream_result: "StreamRunResult", model: Union["Model", str]
    ) -> str:
        """
