...
class DurableExecutionStorage(ABC):
    ...
    def save_state(self, execution_id: str, state: ExecutionState) -> None:
    ...
    def cleanup_old_executions(self, older_than_days: int = 7) -> int:
        ...
        try:
            ...
            return loop.run_until_complete(
                self.cleanup_old_executions_async(older_than_days)
            )
        except RuntimeError:
